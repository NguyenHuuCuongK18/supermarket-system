...
public class CreateOrderActivityCustomer extends BaseActivity {
    ...
    private void checkoutOrder() {
        ...
        if (etCustomerName == null || etPhoneNumber == null || etAddress == null) {
        ...
        saveOrderToDatabase(customerName, phoneNumber, address, totalAmount + SHIPPING_FEE);
        new Thread(() -> {
            try {
                ...
                runOnUiThread(() -> {
                    ...
                    handleCreateOrder(customerName, phoneNumber, address);
                });
            } catch (Exception e) {
                runOnUiThread(() ->
    ...
    private void handleCreateOrder(String customerName, String phoneNumber, String address) {
    ...
    private void saveOrderToDatabase(String customerName, String phoneNumber, String address, double totalAmount) {
        new Thread(() -> {
            try {
                ...
                order.setOrder_date(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault()).format(new Date()));
